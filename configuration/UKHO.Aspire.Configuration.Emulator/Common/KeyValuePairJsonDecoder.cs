...
namespace UKHO.Aspire.Configuration.Emulator.Common
{
    ...
    {
        public IEnumerable<KeyValuePair<string, string?>> Decode(JsonDocument document, string? prefix = null, string? separator = null)
        {
            return Decode(document.RootElement, prefix, separator);
        }

        private IEnumerable<KeyValuePair<string, string?>> Decode(JsonElement element, string? prefix = null, string? separator = null)
        {
