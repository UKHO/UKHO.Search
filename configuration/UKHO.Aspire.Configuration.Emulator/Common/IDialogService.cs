...
namespace UKHO.Aspire.Configuration.Emulator.Common
{
    ...
    {
        /// <summary>
        ///     Gets a task that completes with the
        ///     <see href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dialog">element</see> that is rendered.
        /// </summary>
        ...
        /// <summary>
        ///     Tries to set the <see href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dialog">element</see> that is
        ///     rendered.
        /// </summary>
        /// <param name="element">
        ///     The <see href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dialog">element</see>
        ///     that is rendered.
        /// </param>
    ...
    {
        /// <summary>
        ///     Invoked when a dialog is closed with the refernece to the dialog and the result that is returned when the dialog is
        ///     closed.
        /// </summary>
