...
namespace UKHO.Aspire.Configuration.Emulator.ConfigurationSettings
{
    ...
    {
        public static async Task<Results<ConfigurationSettingResult, NoContent, PreconditionFailedResult, ReadOnlyResult>> Delete([FromServices] IConfigurationSettingRepository repository,
        ...
        public static async Task<Results<ConfigurationSettingResult, NotFound, NotModifiedResult, PreconditionFailedResult>> Get([FromServices] IConfigurationSettingRepository repository,
            [FromRoute] string key,
            [FromQuery] string label = LabelFilter.Null,
        ...
        public static async Task<Results<ConfigurationSettingsResult, InvalidCharacterResult, TooManyValuesResult>> List([FromServices] IConfigurationSettingRepository repository,
        ...
        public static async Task<Results<ConfigurationSettingResult, PreconditionFailedResult, ReadOnlyResult>> Set([FromServices] IConfigurationSettingRepository repository,
