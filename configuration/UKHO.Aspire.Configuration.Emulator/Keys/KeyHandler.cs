...
namespace UKHO.Aspire.Configuration.Emulator.Keys
{
    public class KeyHandler
    {
        public static async Task<Results<KeysResult, InvalidCharacterResult, TooManyValuesResult>> List([FromServices] IConfigurationSettingRepository repository, [FromQuery] string name = KeyFilter.Any, [FromQuery(Name = "$select")] string? select = default, [FromHeader(Name = "Accept-Datetime")] DateTimeOffset? acceptDatetime = default, CancellationToken cancellationToken = default)
        {
