...
**Target output path:** `dev/work-packages/mvp/055-rule-exists-semantics/spec-domain-rule-exists-semantics_v0.01.md`
...
Relevant wiki pages under `./wiki` and the current practical rule-authoring guide under `wiki/Ingestion-Rules.md` shall be updated to describe the completed boolean `exists` semantics.
...
- `wiki/Ingestion-Rules.md` describes both boolean forms
