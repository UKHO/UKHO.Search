...
Work Package folder: `dev/work-packages/mvp/007-enrichment/`

This plan implements `dev/work-packages/mvp/007-enrichment/spec-enrichment-complete_v0.01.md` using vertical slices. Each Work Item ends in a runnable ingestion pipeline (queue -> dispatch -> (enrichment) -> bulk index -> ack/dead-letter) with tests.
