...
Supersedes: `dev/work-packages/mvp/007-enrichment/archive/spec-overview-enrichment_v0.04.md`

## Change Log
- v0.05: Updated referenced file share provider component spec version (v0.05).
...
- `dev/work-packages/mvp/007-enrichment/spec-ingestion-enrichment-core_v0.04.md`
- `dev/work-packages/mvp/007-enrichment/spec-ingestion-fileshare-provider-enrichment_v0.05.md`
