...
Supersedes: `dev/work-packages/mvp/007-enrichment/archive/spec-overview-enrichment_v0.06.md`

## Change Log
- v0.07: Updated referenced core component spec version (v0.05).
...
- `dev/work-packages/mvp/007-enrichment/spec-ingestion-enrichment-core_v0.05.md`
