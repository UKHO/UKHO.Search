...
Supersedes: `dev/work-packages/mvp/007-enrichment/archive/spec-overview-enrichment_v0.07.md`

## Change Log
- v0.08: Updated referenced core component spec version (v0.06) to include enrichment retry configuration keys stored under `ingestion:`.
...
- `dev/work-packages/mvp/007-enrichment/spec-ingestion-enrichment-core_v0.06.md`
- `dev/work-packages/mvp/007-enrichment/spec-ingestion-fileshare-provider-enrichment_v0.06.md`
