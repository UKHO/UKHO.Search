...
Supersedes: `dev/work-packages/mvp/007-enrichment/archive/spec-overview-enrichment_v0.02.md`

## Change Log
- v0.03: Confirmed the name of the context payload as `IngestionPipelineContext`.
...
- A context payload (`IngestionPipelineContext`) that allows enrichment to access both `IngestionRequest` and `CanonicalDocument` at the pre-index stage
...
- `UKHO.Search.Ingestion` (Domain)
  ...
  - Defines `IngestionPipelineContext` (request + operation)
...
- `dev/work-packages/mvp/007-enrichment/spec-ingestion-enrichment-core_v0.03.md`
- `dev/work-packages/mvp/007-enrichment/spec-ingestion-fileshare-provider-enrichment_v0.03.md`
