...
Supersedes: `dev/work-packages/mvp/007-enrichment/archive/spec-ingestion-fileshare-provider-enrichment_v0.03.md`

## Change Log
- v0.04: Confirmed that the provider pipeline uses `IngestionPipelineContext` (from `UKHO.Search.Ingestion.Pipeline`) as the pre-index enrichment payload.
