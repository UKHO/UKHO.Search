...
Supersedes: `dev/work-packages/mvp/007-enrichment/archive/spec-ingestion-enrichment-core_v0.06.md`

## Change Log
- v0.07: Confirmed transient failure detection strategy: whitelist-only (explicit exception types).
