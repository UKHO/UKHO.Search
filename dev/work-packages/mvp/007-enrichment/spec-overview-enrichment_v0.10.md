...
Supersedes: `dev/work-packages/mvp/007-enrichment/archive/spec-overview-enrichment_v0.09.md`

## Change Log
- v0.10: Updated referenced core component spec version (v0.08) to include `IOException` in transient retry whitelist.
...
- `dev/work-packages/mvp/007-enrichment/spec-ingestion-enrichment-core_v0.08.md`
