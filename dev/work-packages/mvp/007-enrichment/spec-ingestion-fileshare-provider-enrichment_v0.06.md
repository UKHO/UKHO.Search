...
Supersedes: `dev/work-packages/mvp/007-enrichment/archive/spec-ingestion-fileshare-provider-enrichment_v0.05.md`

## Change Log
- v0.06: Confirmed DI lifetime for enrichers as `Scoped`.
...
### 3.5 Ingestion service integration
