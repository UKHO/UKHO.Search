...
Version: `v0.02`  
Status: `Draft`  
Work Package: `dev/work-packages/mvp/011-canonical-document/`  
Supersedes: `dev/work-packages/mvp/011-canonical-document/spec-overview-canonical-document_v0.01.md`
...
- `dev/work-packages/mvp/011-canonical-document/spec-canonical-document-model-and-index_v0.03.md`
