...
Based on: `dev/work-packages/mvp/032-rule-workbench/spec.md`

Target output path: `dev/work-packages/mvp/032-rule-workbench/plans/plan-rule-workbench-implementation_v0.01.md`

## Work Package
- Location: `dev/work-packages/mvp/032-rule-workbench/`
- Scope: Implement the Rule Workbench UI (Blazor Server) + evaluation/reporting functionality described in `dev/work-packages/mvp/032-rule-workbench/spec.md`.
