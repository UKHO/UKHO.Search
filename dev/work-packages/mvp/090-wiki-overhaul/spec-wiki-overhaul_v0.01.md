...
Version: `v0.01`  
Status: `Draft`  
Work Package: `dev/work-packages/mvp/090-wiki-overhaul/`  
...
- rewriting historical work-package specifications under `dev/work-packages/mvp/`
...
- historical and architectural context under `dev/work-packages/mvp/`
...
## Target output paths
- `dev/work-packages/mvp/090-wiki-overhaul/spec-wiki-overhaul_v0.01.md`
