...
Work Package: `dev/work-packages/mvp/012-ingestion-rules/`

This plan implements **all** requirements in `dev/work-packages/mvp/012-ingestion-rules/spec-ingestion-rules-engine_v0.01.md`, including the complete automated test suite described in §9.
