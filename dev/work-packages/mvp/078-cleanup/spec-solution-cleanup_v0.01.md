...
**Target output path:** `dev/work-packages/mvp/078-cleanup/spec-solution-cleanup_v0.01.md`
...
- `v0.01` — Captures the intent to remove Theia runtime/build integration, purge Theia references from wiki and other non-`dev/work-packages/mvp/` documentation, and remove `StudioServiceHost` from Aspire without deleting its code.
...
- repository documentation outside `dev/work-packages/mvp/` should stop directing users toward Theia workflows
...
- `wiki` and other non-`dev/work-packages/mvp/` documentation no longer contain active Theia-oriented setup, build, verification, or operational guidance
...
4. repository documentation outside `dev/work-packages/mvp/` is reviewed and Theia-related tasks are purged
