...
**Target output path:** `dev/work-packages/mvp/095-signal-extraction-rules/spec-wiki-query-documentation-update_v0.01.md`

**Version:** v0.01 (Draft)

**Related work package:** `dev/work-packages/mvp/095-signal-extraction-rules/`

**Primary source documents:**

- `dev/work-packages/mvp/095-signal-extraction-rules/spec-domain-query-signal-extraction-rules_v0.01.md`
- `dev/work-packages/mvp/095-signal-extraction-rules/plan-query-signal-extraction-rules_v0.01.md`
