...
Target output path: `dev/work-packages/mvp/043-remove-document-id/plan.md`
...
- `dev/work-packages/mvp/043-remove-document-id/spec.md`
- `dev/work-packages/mvp/043-remove-document-id/plan.md`
...
- [x] Work Item 1: Remove `documentId` from mapping, validation, and tests end-to-end - Completed
  ...
  - **Files**:
    ...
    - `dev/work-packages/mvp/043-remove-document-id/spec.md`: source specification.
    - `dev/work-packages/mvp/043-remove-document-id/plan.md`: execution plan.
