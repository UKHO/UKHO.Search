...
**Target output path:** `dev/work-packages/mvp/006-ingestion-service/006-ingestion-service.spec.md`

**Version:** v0.01 (Draft)

## 0. Related documents

- Pipeline runtime design (ordering/backpressure/error semantics): `dev/work-packages/mvp/002-pipeline-playground/002-pipeline-playground.spec.md`
- Ingestion request model (input contract): `dev/work-packages/mvp/004-ingestion-model-uplift/spec-overview-ingestion-model-uplift_v0.01.md`
- Ingestion pipeline design note (stage list and canonical document shape; enrichment deferred): `dev/work-packages/mvp/006-ingestion-service/elasticsearch_ingestion_pipeline_design.md`
