...
**Target output path:** `dev/work-packages/mvp/006-ingestion-service/plans/backend/plan-ingestion-pipeline_v0.01.md`

**Based on:** `dev/work-packages/mvp/006-ingestion-service/006-ingestion-service.spec.md` (v0.01)

**Architecture reference (must read alongside this plan):** `dev/work-packages/mvp/006-ingestion-service/architecture-ingestion-pipeline_v0.01.md`
...
- [x] **Work Item 7: Ensure metrics/logging/shutdown semantics match spec and update docs** - Completed
  ...
  - [x] Task 7.3: Documentation - Completed
    - [x] Step: Update `dev/work-packages/mvp/006-ingestion-service/006-ingestion-service.spec.md` if implementation differs. - Completed
    - [x] Step: Add an operator README under `dev/work-packages/mvp/006-ingestion-service/` describing how to run locally (Azurite + Elasticsearch) and how to inspect dead-letter. - Completed
  - **Files**:
    - `dev/work-packages/mvp/006-ingestion-service/README.md`: local runbook.
  ...
  - **Work Item 7 Summary**:
    ...
    - Added `dev/work-packages/mvp/006-ingestion-service/README.md` local runbook and updated the spec to document optional dead-letter fatal/continue configuration.
