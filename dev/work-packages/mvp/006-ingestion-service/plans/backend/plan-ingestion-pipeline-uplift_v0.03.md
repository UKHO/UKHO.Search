...
**Target output path:** `dev/work-packages/mvp/006-ingestion-service/plans/backend/plan-ingestion-pipeline-uplift_v0.03.md`

**Based on:** `dev/work-packages/mvp/006-ingestion-service/006-ingestion-service.spec.md` (v0.01 + latest clarifications on File Share provider ownership)

**Supersedes:** `dev/work-packages/mvp/006-ingestion-service/plans/backend/plan-ingestion-pipeline-uplift_v0.02.md`
...
- [x] **Work Item 4: Remove legacy Infrastructure-owned FileShare node implementations and consolidate docs** - Completed
  ...
  - [x] Task 4.2: Documentation touch-ups
    - [x] Step: Update `dev/work-packages/mvp/006-ingestion-service/README.md` if it references old locations.
  - **Summary**:
  ...
  - **Files**:
    ...
    - `dev/work-packages/mvp/006-ingestion-service/README.md`
