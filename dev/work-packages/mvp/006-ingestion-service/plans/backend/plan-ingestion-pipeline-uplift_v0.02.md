...
**Target output path:** `dev/work-packages/mvp/006-ingestion-service/plans/backend/plan-ingestion-pipeline-uplift_v0.02.md`

**Based on:** `dev/work-packages/mvp/006-ingestion-service/006-ingestion-service.spec.md` (v0.01 + clarifications)

**Related existing plan:** `dev/work-packages/mvp/006-ingestion-service/plans/backend/plan-ingestion-pipeline_v0.01.md`
