...
**Target output path:** `dev/work-packages/mvp/054-rule-title/plan-ingestion-canonical-title_v0.01.md`

**Version:** `v0.01` (Draft)

**Based on:** `dev/work-packages/mvp/054-rule-title/spec-domain-canonical-document-title_v0.01.md`
