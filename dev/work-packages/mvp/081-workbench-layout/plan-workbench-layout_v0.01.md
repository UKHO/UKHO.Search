...
**Target output path:** `dev/work-packages/mvp/081-workbench-layout/plan-workbench-layout_v0.01.md`

**Based on:** `dev/work-packages/mvp/081-workbench-layout/spec-workbench-layout_v0.01.md`
