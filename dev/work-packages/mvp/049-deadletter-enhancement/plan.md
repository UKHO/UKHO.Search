...
**Target output path:** `./dev/work-packages/mvp/049-deadletter-enhancement/plan.md`

**Based on:** `dev/work-packages/mvp/049-deadletter-enhancement/spec.md`
...
- Documentation remains within `dev/work-packages/mvp/049-deadletter-enhancement/*`.
...
- [x] Work Item 3: Verify end-to-end index dead-letters contain the failed document and are usable for diagnosing `geoPolygons` parsing failures - Completed
  ...
  - **Files**:
    ...
    - `dev/work-packages/mvp/049-deadletter-enhancement/spec.md`: Clarification-only updates if implementation resolves the remaining open question.
