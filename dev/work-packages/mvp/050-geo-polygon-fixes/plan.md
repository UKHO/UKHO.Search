...
**Target output path:** `./dev/work-packages/mvp/050-geo-polygon-fixes/plan.md`

**Based on:** `dev/work-packages/mvp/050-geo-polygon-fixes/spec.md`
...
- Documentation remains within `dev/work-packages/mvp/050-geo-polygon-fixes/*`.
...
- [x] Work Item 3: Harden the indexing contract and verification so geo-shape payloads are valid, inspectable, and regression-safe - Completed
  ...
  - **Files**:
    ...
    - `dev/work-packages/mvp/050-geo-polygon-fixes/spec.md`: Clarification-only updates if required.
