...
**Target output path:** `dev/work-packages/mvp/060-studio-host-rename/spec-domain-studio-host-rename_v0.01.md`
...
- recent work-package documents such as `dev/work-packages/mvp/058-studio-config/spec-domain-studio-config_v0.01.md` also describe the current studio API host using the `StudioHost` name
