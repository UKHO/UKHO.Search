...
**Target output path:** `dev/work-packages/mvp/080-workbench-initial/spec-frontend-workbench-home-radzen-mockup_v0.01.md`
...
- the output must remain a single specification document in `dev/work-packages/mvp/080-workbench-initial`
