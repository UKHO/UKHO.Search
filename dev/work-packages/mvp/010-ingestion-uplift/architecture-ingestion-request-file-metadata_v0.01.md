...
Work Package: `dev/work-packages/mvp/010-ingestion-uplift/`

Related spec: `dev/work-packages/mvp/010-ingestion-uplift/spec-ingestion-request-file-metadata_v0.01.md`
