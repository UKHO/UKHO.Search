...
**Target output path:** `dev/work-packages/mvp/058-studio-config/spec-domain-studio-config_v0.01.md`
...
This package builds on the shell baseline established in `dev/work-packages/mvp/057-studio-shell/spec-domain-studio-shell_v0.01.md` and turns the previously reserved future API hook into an active runtime configuration contract.
