...
Version: v0.01  
Status: Draft  
Work Package: `dev/work-packages/mvp/009-metric-integration/`
...
- `dev/work-packages/mvp/009-metric-integration/spec-pipelines-node-metrics_v0.01.md`
- `dev/work-packages/mvp/009-metric-integration/spec-service-defaults-otel-meters_v0.01.md`
