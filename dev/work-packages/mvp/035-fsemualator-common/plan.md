...
Work package: `dev/work-packages/mvp/035-fsemualator-common/`

This plan implements the specification in `dev/work-packages/mvp/035-fsemualator-common/spec.md` by introducing a shared library that is the *only* place where the canonical ingestion message and strict `SecurityTokens` policy is built.
