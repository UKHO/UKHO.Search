...
**Target path:** `dev/work-packages/mvp/039-ingestion-mode/plan.md`
...
- [x] Work Item 1: Add `ingestionMode` to AppHost configuration and propagate to services - Completed
  ...
  - **Definition of Done**:
    ...
    - Documentation (`dev/work-packages/mvp/039-ingestion-mode/spec.md`) remains the source of truth.
