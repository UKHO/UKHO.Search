...
**Target output path:** `dev/work-packages/mvp/034-ingestion-rule-parsing-operators/plan.md`
...
- [x] Work Item 1: Implement `toInt(...)` operator in rule value expansion and apply to int taxonomy actions - Completed
  ...
  - **Definition of Done**:
    ...
    - Documentation updated (`wiki/Ingestion-Rules.md` already updated in this work package)
