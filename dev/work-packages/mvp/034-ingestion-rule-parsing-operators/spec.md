...
**Target output path:** `dev/work-packages/mvp/034-ingestion-rule-parsing-operators/spec.md`
...
6. `wiki/Ingestion-Rules.md` is updated to:
...
### 9.1 Update `wiki/Ingestion-Rules.md`

The ingestion rules guide (`wiki/Ingestion-Rules.md`) MUST be updated as part of this work item.
