...
**Target output path:** `dev/work-packages/mvp/004-ingestion-model-uplift/spec-overview-ingestion-model-uplift_v0.01.md`
...
1. `AddItemRequest`
   - Spec: `dev/work-packages/mvp/004-ingestion-model-uplift/spec-domain-add-item-request_v0.01.md`
2. `UpdateItemRequest`
   - Spec: `dev/work-packages/mvp/004-ingestion-model-uplift/spec-domain-update-item-request_v0.01.md`
3. `DeleteItemRequest`
   - Spec: `dev/work-packages/mvp/004-ingestion-model-uplift/spec-domain-delete-item-request_v0.01.md`
4. `UpdateAclRequest`
   - Spec: `dev/work-packages/mvp/004-ingestion-model-uplift/spec-domain-update-acl-request_v0.01.md`
5. `IngestionRequest` envelope + `IngestionRequestType`
   - Spec: `dev/work-packages/mvp/004-ingestion-model-uplift/spec-domain-ingestion-request-envelope_v0.01.md`
