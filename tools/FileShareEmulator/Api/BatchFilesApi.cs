...
namespace FileShareEmulator.Api
{
    public static class BatchFilesApi
    {
        ...
        {
            endpoints.MapGet("/batch/{batchId}/files", async (string batchId, BlobServiceClient blobServiceClient, IConfiguration configuration, HttpContext httpContext, CancellationToken cancellationToken) =>
                     {
