...
Supersedes: `docs/007-enrichment/archive/spec-overview-enrichment_v0.02.md`
...
- `docs/007-enrichment/spec-ingestion-enrichment-core_v0.03.md`
- `docs/007-enrichment/spec-ingestion-fileshare-provider-enrichment_v0.03.md`
