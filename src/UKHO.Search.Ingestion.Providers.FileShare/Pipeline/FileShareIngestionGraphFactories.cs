...
{
    public sealed record FileShareIngestionGraphFactories
    {
        public required Func<string, ChannelWriter<Envelope<IngestionRequest>>, PipelineSupervisor, INode> CreateSourceNode { get; init; }
