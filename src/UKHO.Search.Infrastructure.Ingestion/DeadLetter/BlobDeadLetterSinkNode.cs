...
namespace UKHO.Search.Infrastructure.Ingestion.DeadLetter
{
    public sealed class BlobDeadLetterSinkNode<TPayload> : SinkNodeBase<Envelope<TPayload>>
    {
        ...
        public BlobDeadLetterSinkNode(string name,
            ChannelReader<Envelope<TPayload>> input,
            BlobServiceClient blobServiceClient,
            IConfiguration configuration,
            bool fatalIfCannotPersist = true,
            string? containerName = null,
            string? blobPrefix = null,
            IDeadLetterMetadataProvider? metadataProvider = null,
            ILogger? logger = null,
            IPipelineFatalErrorReporter? fatalErrorReporter = null,
            string? providerName = null) : base(name, input, logger, fatalErrorReporter, providerName: providerName)
        {
