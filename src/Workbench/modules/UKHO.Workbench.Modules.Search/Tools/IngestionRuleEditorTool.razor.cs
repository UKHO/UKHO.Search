...
{
    /// <summary>
    /// Renders the dummy ingestion rule editor tool used to complete the initial Search module map.
    /// </summary>
    public partial class IngestionRuleEditorTool
    {
        ...
        /// <summary>
        /// Gets or sets the bounded Workbench tool context for the active ingestion rule editor tool instance.
        /// </summary>
        [Parameter]
        [EditorRequired]
        ...
        protected override void OnParametersSet()
        {
            ...
            ToolContext.SetTitle("Ingestion rule editor");
            ToolContext.SetIcon("rule");
            ToolContext.SetBadge(null);
            ToolContext.SetSelection(null, 0);
            ToolContext.SetRuntimeStatusBarContributions(
            [
                new StatusBarContribution("status.runtime.search.rule-editor.ready", "Ingestion rule editor ready", ownerToolId: IngestionRuleEditorToolId, order: 200)
            ]);
