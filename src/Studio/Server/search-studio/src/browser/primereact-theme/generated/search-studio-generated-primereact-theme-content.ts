...
const searchStudioPrimeReactGeneratedThemeDefinitions: Record<SearchStudioPrimeReactGeneratedThemeVariant, SearchStudioPrimeReactGeneratedThemeDefinition> = {
    light: {
        themeVariant: 'light',
        fileName: 'ukho-theia-light.css',
        stylesheetContent: `/*
 * Generated for UKHO Search Studio from the PrimeReact SASS workspace baseline and Studio-owned theme source.
 * Runtime PrimeReact package version: 10.9.7.
 * Upstream/reference primereact-sass-theme workspace version: 10.8.5.
 * Generated theme variant: light.
 * Upstream baseline artifact: build/themes/lara/lara-light/blue/theme.css.
 * Studio-owned theme source: ukho-theia-light/theme.scss.
...
:root {
  color-scheme: light;
  --font-family: var(--theia-ui-font-family, "Segoe UI", Tahoma, Geneva, Verdana, sans-serif);
  --surface-a: #ffffff;
  --surface-b: #f4f7fb;
  --surface-c: #ffffff;
  --surface-d: #e8eef6;
  --surface-e: #ffffff;
  --surface-f: #f4f7fb;
  --surface-ground: #f4f7fb;
  --surface-section: #f4f7fb;
  --surface-card: #ffffff;
  --surface-overlay: #ffffff;
  --surface-border: #d3dce8;
  --surface-hover: #e8eef6;
  --surface-0: #ffffff;
  --surface-50: #f4f7fb;
  --text-color: #16212d;
  --text-color-secondary: #526170;
  --primary-color: #0b5cab;
  --primary-color-text: #ffffff;
  --highlight-bg: #dcecff;
  --highlight-text-color: #0b3b69;
  --maskbg: rgba(15, 23, 42, 0.16);
  --content-border-radius: 0.375rem;
  --focus-ring: 0 0 0 0.1rem rgba(11, 92, 171, 0.22);
  --ukho-primereact-theme-name: ukho-theia-light;
}
...
.p-paginator .p-paginator-last {
  ...
  gap: 0.5rem;
    ...
    dark: {
        themeVariant: 'dark',
        fileName: 'ukho-theia-dark.css',
        stylesheetContent: `/*
 * Generated for UKHO Search Studio from the PrimeReact SASS workspace baseline and Studio-owned theme source.
 * Runtime PrimeReact package version: 10.9.7.
 * Upstream/reference primereact-sass-theme workspace version: 10.8.5.
 * Generated theme variant: dark.
 * Upstream baseline artifact: build/themes/lara/lara-dark/blue/theme.css.
 * Studio-owned theme source: ukho-theia-dark/theme.scss.
 * The first Studio-owned iteration intentionally reuses Theia's UI font family contract via --theia-ui-font-family and does not introduce hosted font assets.
 */
:root {
  --surface-a: #1f2937;
...
:root {
  ...
  --surface-e: #192430;
  --surface-f: #121a24;
  --surface-ground: #121a24;
  --surface-section: #121a24;
  --surface-card: #192430;
  --surface-overlay: #1e2935;
  --surface-border: #314252;
  --surface-hover: #253443;
  --surface-0: #192430;
  --surface-50: #121a24;
  --text-color: #e4ebf2;
  --text-color-secondary: #9eb0c3;
  --primary-color: #5ca9ff;
  --primary-color-text: #0f1820;
  --highlight-bg: #1f3550;
  --highlight-text-color: #d7e9ff;
  --maskbg: rgba(2, 8, 23, 0.42);
  --content-border-radius: 0.375rem;
  --focus-ring: 0 0 0 0.1rem rgba(92, 169, 255, 0.28);
  --ukho-primereact-theme-name: ukho-theia-dark;
}
